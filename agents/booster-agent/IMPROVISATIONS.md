...
Last run: 2026-08-31T06:40:00+00:00

## ✅ SHIPPED — Mind World scroll + POI hop polish + industry_hour SQL

- **What:** Mind shell uses `overflow-x: clip` so sticky chrome and World jump work (hidden+visible was forcing overflow-y:auto). Industry hour ring persists in Cloud SQL `industry_hour`. World caption shows hub/sample. Place=Tokyo floats Kyoto into the pin cap (450 km). Co-located hops bow + enlarge pins.
